...
const features = [
    ...
    // Shape & Pattern Tools
     {
        name: "Auto-Tile (9-Tile)",
        short: "Automatically places the correct tile to form connections.",
        long: "This powerful offline tool makes drawing environments like walls or simple paths incredibly fast. For this feature to work, you must create and select a complete 9-tile set.\n\nThe system is strict: you must select exactly 9 tiles. If your set is incomplete, the tool will show an error and will not draw.\n\nHere is the required layout and the order to select your tiles in the palette:\n1. Top-Left Corner\n2. Top Edge\n3. Top-Right Corner\n4. Left Edge\n5. Center (fully surrounded)\n6. Right Edge\n7. Bottom-Left Corner\n8. Bottom Edge\n9. Bottom-Right Corner\n\nOnce you have your tiles arranged this way in your palette: select the Auto-Tile tool, click all 9 tiles in order to add them to the set, and then draw on the canvas. The tool will analyze neighbors and place the correct tile automatically."
    },
    {
        name: "Rectangle",
