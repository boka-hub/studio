...
const TerrainConfigSchema = z.object({
  type: z.enum(['forest', 'desert', 'beach', 'volcanic', 'alien', 'grassland', 'jungle', 'mountains', 'swamp', 'crystal_caves', 'tundra', 'wasteland', 'farmland', 'ruins']).describe('The type of terrain to generate.'),
  tileMapping: z
